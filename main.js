...
var stim_c = ['<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag" onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の趣味は<input name="ms" type="text" id="mines" required="required"/>です。         友人の趣味は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              ...
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の特技は<input name="ms" type="text" id="mines" required="required"/>です。         友人の特技は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きなスポーツは<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きなスポーツは<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きな食べ物は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きな食べ物は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きな飲み物は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きな飲み物は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の嫌いな食べ物は<input name="ms" type="text" id="mines" required="required"/>です。         友人の嫌いな食べ物は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の得意な教科は<input name="ms" type="text" id="mines" required="required"/>です。         友人の得意な教科は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の苦手な教科は<input name="ms" type="text" id="mines" required="required"/>です。         友人の苦手な教科は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きな季節は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きな季節は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きな本は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きな本は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きなテレビ番組は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きなテレビ番組は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の好きな芸能人は<input name="ms" type="text" id="mines" required="required"/>です。         友人の好きな芸能人は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の嫌いな芸能人は<input name="ms" type="text" id="mines" required="required"/>です。         友人の嫌いな芸能人は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の将来の夢は<input name="ms" type="text" id="mines" required="required"/>です。         友人の将来の夢は<input name="ys" type="text" id="youans"/>です。</p></pre>',
              '<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または、<b>異なる回答が思い浮かばない場合</b>は</p>'+'<p>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px  onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の将来の夢は<input name="ms" type="text" id="mines" required="required"/>です。         友人の将来の夢は<input name="ys" type="text" id="youans"/>です。</p></pre>'
            ]
