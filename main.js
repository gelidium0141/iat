...
var stim_c = ['<br><p><b>自分と友人、どちらか一方の回答がわからない場合</b>または<b>異なる回答が思い浮かばない場合</b>は<br>右のボタンにチェックをしてください<input type="checkbox", id= scales", name="tag",  style="width:30px;height:30px　onClick="tagflg0(this.checked);" ><br></p><br>'+'<pre><p> 私の趣味は<input name="ms" type="text" id="mines" required="required"/>です。         友人の趣味は<input name="ys" type="text" id="youans"/>です。</p></pre>',
