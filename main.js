...
var name_get = {
  type: 'survey-text',
  questions: [
        {prompt: '<p>次に行う課題で刺激として利用するため名前の記入をお願いしております。</p>'+'<p>ここで収集した名前については、次の課題でのみ使用し、分析には使用致しません。</p><br>'+'<b>あなたの名字（姓）（例：山田太郎さんなら山田）</b>を入力してください', name: 'name_up', required:'True'},
...
var oname_get = {
  type: 'survey-text',
  questions: [
        {prompt: '<p>次に行う課題で刺激として利用するため名前の記入をお願いしております。</p>'+'<p>ここで収集した名前については、次の課題でのみ使用し、分析には使用致しません。<br><br></p>'+'<p>先ほど思い浮かべた友人の名前を入力してください。</p>'+'<p>名前の漢字がどうしてもわからない場合は、ひらがなでお答えください</p><br>'+'<b>先ほど思い浮かべた友人の名字 (性)（例：山田太郎さんなら山田）</b>を入力してください', name: 'fname_up', required:'True'},
      　{prompt: '<b>先ほど思い浮かべた友人の名前 (名)（例：山田太郎さんなら太郎）</b>を入力してください', name: 'fname_do', required:'True'},
