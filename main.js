...
var trial_block2 = {
  ...
  timeline_variables: [
   ...
   {stimulus: function(){
    ...
    {stimulus: "nsahdas", stim_key_association: 'right'},
    {stimulus: "ajaa", stim_key_association: 'right'},
    {stimulus: "sss", stim_key_association: 'right'},
    {stimulus: "sjo", stim_key_association: 'right'}
  ],
  randomize_order:true,
  repetitions: 2
};
